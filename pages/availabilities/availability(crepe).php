...
<html>
    ...
    <body>
        ...
        <main role="main"> 
            <div>
                <h1> Welcome to </h1>
                Crepe Corner! Below are the available reviews for this spot.                
            </div>
            <div id="homelinks2">
                <a class="ar" href="/pages/reviews/crepe.php"><span>Crepe</span></a>
                <a class="ar" href="/pages/reviews/cheesecake.php"><span>Cheesecake</span></a>
            </div>
        </main>
